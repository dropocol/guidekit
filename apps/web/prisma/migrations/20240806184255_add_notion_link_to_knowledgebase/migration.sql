...
-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_knowledgebaseId_fkey" FOREIGN KEY ("knowledgebaseId") REFERENCES "Knowledgebase"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
