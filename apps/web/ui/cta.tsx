...
export default function CTA() {
  ...
  return (
    <div
      ...
      } fixed inset-x-0 bottom-5 mx-5 flex max-w-screen-lg flex-col items-center justify-between space-y-3 rounded-lg border-t-4 border-black bg-white px-5 pb-3 pt-0 drop-shadow-lg transition-all duration-150 ease-in-out lg:flex-row lg:space-y-0 lg:pt-3 xl:mx-auto dark:border
    ...
    >
      ...
      <div className="text-center lg:text-left">
        ...
        >
          This is a demo site showcasing a knowledge base built with GuideKit.
        </p>
      </div>
      <div
        className={`${
